...
class XiechengSpider(CrawlSpider):
    ...
    def scenic_comments(self,response):     
        ...
        co_scenic_id = response.meta['scenic_id']
        ...
        if obj_comments['Comment'] != [] :
            ...
            for comment in comments:
                ...
                # scenic_comments['comment_id'] = comment['CommentID']     
                scenic_comments['con'] = comment['con']
                scenic_comments['date'] = comment['date']
                # scenic_comments['title'] = comment['title']   #数据全为空
                ...
                scenic_comments['scenic_id'] = co_scenic_id
                print('开始写入评论')
